...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Peering.description'
        db.add_column('app_peering', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Peering.custom'
        db.add_column('app_peering', 'custom',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Peering.description'
        db.delete_column('app_peering', 'description')

        # Deleting field 'Peering.custom'
        db.delete_column('app_peering', 'custom')
